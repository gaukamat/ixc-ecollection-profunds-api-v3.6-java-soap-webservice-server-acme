...
ECHO Message Integrity: Payload, No XML Decl (Message Body) policy configuration defaults. 
copy src\main\resources\policy-defaults\message-integrity\integrity-validator-defaults-message-payload-NoXmlDecl-message-body.properties  src\main\resources\policy-defaults\integrity-validator-defaults.properties
...
SET DEPLOYMENT_IMAGE_TAG=2.0.0-configrity-integrity-payload-noxmldecl-message-body-custom-auth-message-body
