...
ECHO Simple Confidentiality (All Fields, Symm) policy configuration defaults. 
copy src\main\resources\policy-defaults\simple-confidentiality\simple-confidentiality-validator-defaults-all-fields-symm-hex.properties  src\main\resources\policy-defaults\simple-confidentiality-validator-defaults.properties
...
SET DEPLOYMENT_IMAGE_TAG=2.0.0-configrity-simple-confi-only-allfields-symm-hex
