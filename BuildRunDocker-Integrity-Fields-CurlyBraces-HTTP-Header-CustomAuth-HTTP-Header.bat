...
ECHO Message Integrity: Fields, Curly Braces (HTTP Header) policy configuration defaults. 
copy src\main\resources\policy-defaults\message-integrity\integrity-validator-defaults-message-fields-curlybraces-http-header.properties  src\main\resources\policy-defaults\integrity-validator-defaults.properties
...
SET DEPLOYMENT_IMAGE_TAG=2.0.0-configrity-integrity-fields-curlybraces-http-header-custom-auth-http-header
