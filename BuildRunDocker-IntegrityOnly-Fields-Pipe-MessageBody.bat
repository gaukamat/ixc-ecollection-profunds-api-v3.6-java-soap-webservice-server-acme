...
ECHO Message Integrity: Fields, Pipe (Message Body) policy configuration defaults. 
copy src\main\resources\policy-defaults\message-integrity\integrity-validator-defaults-message-fields-pipe-message-body.properties  src\main\resources\policy-defaults\integrity-validator-defaults.properties
...
SET DEPLOYMENT_IMAGE_TAG=2.0.0-configrity-integrity-fields-pipe-message-body
