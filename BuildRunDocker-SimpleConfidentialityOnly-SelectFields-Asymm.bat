...
ECHO Simple Confidentiality (Select Fields, Asymm) policy configuration defaults. 
copy src\main\resources\policy-defaults\simple-confidentiality\simple-confidentiality-validator-defaults-select-fields-asymm.properties  src\main\resources\policy-defaults\simple-confidentiality-validator-defaults.properties
...
SET DEPLOYMENT_IMAGE_TAG=2.0.0-configrity-simple-confi-only-selectfields-asymm
