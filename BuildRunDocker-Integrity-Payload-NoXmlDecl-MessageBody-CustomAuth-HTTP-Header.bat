...
ECHO Custom Authentication (HTTP Header) policy configuration defaults. 
copy src\main\resources\policy-defaults\api-authentication\user-authentication-custom-http-header.properties  src\main\resources\policy-defaults\user-authentication-defaults.properties
...
SET DEPLOYMENT_IMAGE_TAG=2.0.0-configrity-integrity-payload-noxmldecl-message-body-custom-auth-http-header
