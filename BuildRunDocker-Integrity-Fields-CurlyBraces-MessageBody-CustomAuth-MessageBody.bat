...
copy src\main\resources\handler-engagement-policies\policy-config-basic-auth-integrity.properties src\main\resources\policy-config.properties

ECHO Message Integrity: Fields, Curly Braces (Message Body) policy configuration defaults. 
copy src\main\resources\policy-defaults\message-integrity\integrity-validator-defaults-message-fields-curlybraces-message-body.properties  src\main\resources\policy-defaults\integrity-validator-defaults.properties

ECHO Custom Authentication (Message Body) policy configuration defaults. 
copy src\main\resources\policy-defaults\api-authentication\user-authentication-custom-message-body.properties  src\main\resources\policy-defaults\user-authentication-defaults.properties
...
SET DEPLOYMENT_IMAGE_TAG=2.0.0-configrity-integrity-fields-curlybraces-message-body-custom-auth-message-body
