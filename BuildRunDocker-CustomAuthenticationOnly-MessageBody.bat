...
copy src\main\resources\handler-engagement-policies\policy-config-basic-auth-only.properties src\main\resources\policy-config.properties
...
SET DEPLOYMENT_IMAGE_TAG=2.0.0-configrity-custom-auth-message-body
