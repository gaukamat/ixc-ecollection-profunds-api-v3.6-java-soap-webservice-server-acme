...
ECHO Message Integrity: Fields, Curly Braces (SOAP Header) policy configuration defaults. 
copy src\main\resources\policy-defaults\message-integrity\integrity-validator-defaults-message-fields-curlybraces-soap-header.properties  src\main\resources\policy-defaults\integrity-validator-defaults.properties
...
SET DEPLOYMENT_IMAGE_TAG=2.0.0-configrity-integrity-fields-curlybraces-soap-header-custom-auth-soap-header
