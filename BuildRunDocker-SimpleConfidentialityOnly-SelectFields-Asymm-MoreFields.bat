...
copy src\main\resources\handler-engagement-policies\policy-config-simple-confi-only.properties src\main\resources\policy-config.properties

ECHO Simple Confidentiality (Select Fields, Asymm, More Fields) policy configuration defaults. 
copy src\main\resources\policy-defaults\simple-confidentiality\simple-confidentiality-validator-defaults-select-fields-asymm-morefields.properties  src\main\resources\policy-defaults\simple-confidentiality-validator-defaults.properties
...
SET DEPLOYMENT_IMAGE_TAG=2.0.0-configrity-simple-confi-only-selectfields-asymm-morefields
