...
copy src\main\resources\policy-defaults\payload-confidentiality\payload-confidentiality-validator-defaults-hex.properties  src\main\resources\policy-defaults\payload-confidentiality-validator-defaults.properties
