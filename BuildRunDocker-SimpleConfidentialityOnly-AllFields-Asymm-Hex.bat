...
ECHO Simple Confidentiality (All Fields, Asymm) policy configuration defaults. 
copy src\main\resources\policy-defaults\simple-confidentiality\simple-confidentiality-validator-defaults-all-fields-asymm-hex.properties  src\main\resources\policy-defaults\simple-confidentiality-validator-defaults.properties
