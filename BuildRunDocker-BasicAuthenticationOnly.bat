...
ECHO Basic Authentication policy configuration defaults. 
copy src\main\resources\policy-defaults\\api-authentication\user-authentication-basic.properties  src\main\resources\policy-defaults\user-authentication-defaults.properties
...
SET DEPLOYMENT_IMAGE_TAG=2.0.0-configrity-basic-auth
