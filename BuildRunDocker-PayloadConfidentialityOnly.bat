...
copy src\main\resources\handler-engagement-policies\policy-config-payload-confi-only-compactv3.properties src\main\resources\policy-config.properties

ECHO Payload Confidentiality policy configuration defaults. 
copy src\main\resources\policy-defaults\payload-confidentiality\payload-confidentiality-validator-defaults-base64.properties  src\main\resources\policy-defaults\payload-confidentiality-validator-defaults.properties
...
SET DEPLOYMENT_IMAGE_TAG=2.0.0-configrity-payload-confi-only
