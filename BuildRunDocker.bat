...
copy src\main\resources\handler-engagement-policies\policy-config-core.properties src\main\resources\policy-config.properties

ECHO No handler policy configuration defaults. 
...
SET DEPLOYMENT_IMAGE_TAG=2.0.0-configrity
