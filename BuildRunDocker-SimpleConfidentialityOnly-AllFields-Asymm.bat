...
copy src\main\resources\policy-defaults\simple-confidentiality\simple-confidentiality-validator-defaults-all-fields-asymm.properties  src\main\resources\policy-defaults\simple-confidentiality-validator-defaults.properties
